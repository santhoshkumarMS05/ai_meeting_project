...
flowchart LR
    ...
    classDef start fill:#4F46E5,stroke:#312E81,color:#fff,stroke-width:2px;
    ...
    classDef action fill:#F59E0B,stroke:#B45309,color:#fff,stroke-width:2px;
...
flowchart TB
    ...
    API --> MEET["🎙️ Meeting Workflow Service"]
    API --> AI["🧠 AI Agents"]
    API --> DB["🗄️ SQLite + MongoDB"]

    AI --> STT["🎧 Speech / Transcript Processing"]
    AI --> PDF["📄 PDF Generator"]
    AI --> EMAIL["📧 Email Agent"]

    MEET --> AUDIO["💾 Audio Storage"]
    DB --> HISTORY["📚 Meeting History"]
    ...
    classDef service fill:#0EA5E9,stroke:#0369A1,color:#fff,stroke-width:2px;
